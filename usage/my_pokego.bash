_pokego () {
    ...
    declare -a literals=(-random -no-title -list -form --help -name -version -shiny)
    declare -A literal_transitions=()
    literal_transitions[1]="([0]=2 [1]=2 [2]=2 [3]=2 [5]=2 [4]=2 [6]=2 [7]=2)"
    ...
    declare -A literal_transitions_level_0=([1]="0 1 2 3 5 4 6 7")
