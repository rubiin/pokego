_pokego () {
    ...
    declare -a literals=(-random -no-title -list -h -form --help -name -version -shiny)
    declare -A literal_transitions=()
    literal_transitions[1]="([0]=2 [1]=2 [3]=2 [2]=2 [4]=2 [6]=2 [5]=2 [7]=2 [8]=2)"
    ...
    declare -A literal_transitions_level_0=([1]="0 1 3 2 4 6 5 7 8")
    ...
    for (( fallback_level=0; fallback_level <= max_fallback_level; fallback_level++ )) {
       ...
       for command_id in "${transitions[@]}"; do
           local completions=()
           readarray -t completions < <(_pokego_cmd_$command_id "$prefix" | cut -f1)
